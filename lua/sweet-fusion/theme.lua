...
function M.setup(palette)
	...
	theme.highlights = {
		...
		NormalNC                                   = { fg = c.fg, bg = options.dim_inactive and c.bg_light or (options.transparency and c.none or c.bg) }, -- normal text in non-current windows
		...
		DiagnosticUnnecessary                      = { fg = c.black_lighter, italic = true, undercurl = true }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default
		...
		--- Dashboard
		-- General
		DashboardHeader           = { fg = c.green_var2 },
		...
		-- obsidian.nvim
		ObsidianTodo                = { bold = true, fg = c.pink_light },
		ObsidianDone                = { bold = true, fg = c.green_var2 },
		ObsidianRightArrow          = { bold = true, fg = c.orange },
		ObsidianTilde               = { bold = true, fg = c.pink },
		ObsidianImportant           = { bold = true, fg = c.red },
		ObsidianBullet              = { bold = true, fg = c.blue },
		ObsidianRefText             = { underline = true, fg = c.yellow },
		ObsidianExtLinkIcon         = { fg = c.purple_var1 },
		ObsidianTag                 = { italic = true, fg = c.blue_var1 },
		ObsidianBlockID             = { italic = true, fg = c.blue },
		ObsidianHighlightText       = { bg = c.yellow },
